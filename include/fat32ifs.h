...
IMPORT BOOL   fGetLongName1(PSZ pszName, USHORT wMax);
/*
...
IMPORT USHORT MakeDirEntry(PVOLINFO pVolInfo, ULONG ulDirCluster, PSHOPENINFO pDirSHInfo, PDIRENTRY pNew, PSZ pszName);
...
IMPORT void SetSHInfo1(PVOLINFO pVolInfo, PSHOPENINFO pSHInfo);
