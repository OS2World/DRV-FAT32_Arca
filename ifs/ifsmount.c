      ...
      case MOUNT_MOUNT  :
         ...
         */
         ...
         if (fValidBoot)
            {
            char pszVolLabel[12];
            //This value is strlen(pszVolLabel) synonomous with FILEINFO->VOLUMELABEL.cch
            //Doesn't matter here because we memset pszVolLabel below which happens again
            //if no label is found by fGetSetVolLabel usSize is reset there after that.
            USHORT usSize;
