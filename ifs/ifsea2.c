...
int i;
   ...
   ulSrcCluster = FindPathCluster(pVolInfo, ulDirCluster, pszFile, pDirSHInfo, pDirEntry, NULL);
...
APIRET rc;
   ...
   rc = ModifyDirectory(pVolInfo, ulDirCluster, pDirSHInfo, MODIFY_DIR_UPDATE, pDirEntry, NULL, pszFile, pszFile, 0);
   if (rc)
      goto usSetEAKeysExit;
